...
ADD vertEdge, tc0, tc2;
MAD vertEdge, tc1, 2.0, vertEdge;
ADD vertEdge, vertEdge, -tc6;
ADD vertEdge, vertEdge, -tc8;
MAD vertEdge, -tc7, 2.0, vertEdge;
MUL vertEdge, vertEdge, vertEdge;

ADD horizEdge, tc2, tc8;
MAD horizEdge, tc5, 2.0, horizEdge;
ADD horizEdge, horizEdge, -tc0;
ADD horizEdge, horizEdge, -tc6;
MAD horizEdge, -tc3, 2.0, horizEdge;
